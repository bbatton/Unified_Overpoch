...
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561197986546735","0","0"]; //do not have a , at the end.
...
[
	...
	"509","SP_refuel_action","SP_repair_action","SP_rearm_actions","s_player_setVectorsReset","s_player_setVectorsForward",
