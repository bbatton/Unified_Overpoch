...
BIS_fnc_numberDigits = compile preprocessFileLineNumbers "Scripts\Player_Hud\numberDigits.sqf";
BIS_fnc_numberText = compile preprocessFileLineNumbers "Scripts\Player_Hud\numberText.sqf"; 
...
if (!isDedicated) then {
	...
	fnc_usec_selfActions = compile preprocessFileLineNumbers "Scripts\Fn_SelfActions\fn_selfActions.sqf";
	...
	dayz_spaceInterrupt = compile preprocessFileLineNumbers "custom\spaceInterrupt.sqf";
